                ...
                <div class="col-sm-9">
                    <!-- cart item -->
                        <div class="row border-top py-3 mt-3">
                            <div class="col-sm-2">
                                <img src="./assets/1.jpg" style="height: 120px;" alt="cart1" class="img-fluid">
                            </div>
                            <div class="col-sm-8">
                                <h5 class="font-baloo font-size-20">Product 1</h5>
                            ...
                            <div class="col-sm-2 text-right">
                                <div class="font-size-20 text-danger font-baloo">
                                    PHP<span class="product_price"> 1.00</span>
                                </div>
                            </div>
                        </div>
                    <!-- !cart item -->
                    ...
                    <div class="row border-top py-3 mt-3">
                        <div class="col-sm-2">
                            <img src="./assets/2.jpg" style="height: 120px;" alt="cart1" class="img-fluid">
                        </div>
                        <div class="col-sm-8">
                            <h5 class="font-baloo font-size-20">Product 2</h5>
                            <small>by Digital Arts</small>
                            <!-- product rating -->
                            <div class="d-flex">
                                <div class="rating text-warning font-size-12">
                        ...
                        <div class="col-sm-2 text-right">
                            <div class="font-size-20 text-danger font-baloo">
                                PHP<span class="product_price"> 2.00</span>
                            </div>
                        </div>
                    </div>
                <!-- !cart item -->
                ...
                <div class="col-sm-3">
                    <div class="sub-total border text-center mt-2">
                        ...
                        <div class="border-top py-4">
                            <h5 class="font-baloo font-size-20">Subtotal (2 item):&nbsp; <span class="text-danger">PHP<span class="PHPext-danger" id="deal-price"> 3.00</span> </span> </h5>
